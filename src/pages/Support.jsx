...
import { ShieldIcon, SunIcon, BoltIcon } from '../icons';
    ...
    <div className="space-y-16 animate-in fade-in duration-700 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <BentoCard accentColor="orange">
          <BoltIcon className="w-8 h-8 text-[var(--orange)] mb-4" />
        ...
        <BentoCard accentColor="lime">
          <SunIcon className="w-8 h-8 text-[var(--lime)] mb-4" />
        ...
        <BentoCard accentColor="orange">
          <ShieldIcon className="w-8 h-8 text-[var(--orange)] mb-4" />
